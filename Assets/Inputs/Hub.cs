...
//     version 1.4.4
//     from Assets/Inputs/Hub.inputactions
//
...
public partial class @Hub : IInputActionCollection2, IDisposable
{
    ...
    {
        private @Hub m_Wrapper;
        public PlayerActions(@Hub wrapper) { m_Wrapper = wrapper; }
    ...
    {
        private @Hub m_Wrapper;
        public UIActions(@Hub wrapper) { m_Wrapper = wrapper; }
