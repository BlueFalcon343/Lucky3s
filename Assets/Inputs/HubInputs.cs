...
//     version 1.4.4
//     from Assets/Inputs/HubInputs.inputactions
//
...
public partial class @HubInputs : IInputActionCollection2, IDisposable
{
    ...
    {
        private @HubInputs m_Wrapper;
        public PlayerActions(@HubInputs wrapper) { m_Wrapper = wrapper; }
    ...
    {
        private @HubInputs m_Wrapper;
        public UIActions(@HubInputs wrapper) { m_Wrapper = wrapper; }
