...
//     version 1.4.4
//     from Assets/Inputs/MenuInputs 1.inputactions
//
...
public partial class @MenuInputs1 : IInputActionCollection2, IDisposable
{
    ...
    {
        private @MenuInputs1 m_Wrapper;
        public PlayerActions(@MenuInputs1 wrapper) { m_Wrapper = wrapper; }
    ...
    {
        private @MenuInputs1 m_Wrapper;
        public UIActions(@MenuInputs1 wrapper) { m_Wrapper = wrapper; }
